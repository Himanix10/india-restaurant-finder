...
## prepare_data.py
### Purpose
The `prepare_data.py` module is responsible for preparing and uploading data to Google Sheets.
...
### Classes
* `RAGEngine`: The main class responsible for loading data, creating a vector index, and processing user queries.
	+ Methods:
		- `__init__`: Initializes the `RAGEngine` object.
